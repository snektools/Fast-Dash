...
def test_create_end_date_type_returned():
    print(dates.create_end_date())
    assert type(dates.create_end_date()) == datetime.datetime


############create_start_date
def test_create_start_date_type_returned():
    end_date = datetime.datetime.now()
    assert type(dates.create_start_date(end_date)) == datetime.datetime
...
def test_str_to_datetime_value_returned(date, string):
    assert dates.str_to_datetime(string) == date
